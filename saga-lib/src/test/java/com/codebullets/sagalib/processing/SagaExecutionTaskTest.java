...
public class SagaExecutionTaskTest {
	...
	public void run_invokerAndModuleFinishThrow_throwsSagaExecutionExceptions() throws InvocationTargetException, IllegalAccessException {
		...
		assertThat("Expected two exceptions in resulting one.", exception.getExecutionErrors(),
				hasItem(instanceOf(NullPointerException.class)));
		assertThat("Expected two exceptions in resulting one.", exception.getExecutionErrors(),
				hasItem(instanceOf(ArithmeticException.class)));
	}
